...
\thispagestyle{empty}
	...
	\section{Conference Presentations}
		...
		\textbf{Silvilaser}, La Grant Motte, France, 2015 - Oral Presentation \newline
	...
	\chapter{The open source software DASOS and its Voxelisation Approach}\label{DASOS_Voxelisation}
	...
	\chapter{Visualisations}\label{Visualisations}
		...
		\newpage
    \chapter{Data Structures}\label{Rep_IntegralVolumes}
