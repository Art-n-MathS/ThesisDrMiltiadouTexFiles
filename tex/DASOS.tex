	...
	\section{The functionalities of DASOS}\label{DASOS}
		...
		\newpage
        		...
        		\begin{longtable}
        			...
        			LAS1.3& \textbf{3D Polygon Mesh } \newline Basic Algorithms and user-defined parameters are explained in Section \ref{Visualisations} while optimisation approaches are discussed in Section \ref{Optimisations}  \newline & \raisebox{-\totalheight}{\adjincludegraphics[width=\linewidth,trim={0 {0.37\width} 0 0},clip]{img/NewForest}} & .obj \\ 
