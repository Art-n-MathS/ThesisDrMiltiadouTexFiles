...
\par For the aforementioned reasons, monitoring dead trees is essential for the ecosystem. Nevertheless, the distribution of dead trees significantly varies making detection of them difficult \cite{Kim2009}. Remote sensing approaches has been introduce to automate the processes and increase its spatial resolution. The following section gives an overview of the related work undertaken. 
