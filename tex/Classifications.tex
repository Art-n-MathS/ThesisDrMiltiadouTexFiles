...
\afterpage{
	...
	\begin{figure} [h!]
		\centering
		\includegraphics[width=0.965\textwidth]{img/DeadTreesExamplePhotos}
...
The study area is a native River Red Gum (Eucalyptus camaldulensis) forest in south-eastern Australia which size is $542km^2$. The regeneration of the eucalyptus is extremely dependant in floods and therefore, their distribution in respect to density, health and age is highly variance \cite{Kerle2005}. Additionally, the height of Eucalyptus camaldulensis reaches up to 30-40m and their structural complexity is high with multiple trunk splits \cite{Wilson1995}. The size and structure of the forest, with a human as reference, is depicted in Figure \ref{fig:EucalyptusSize}, while examples of the invariance shape of dead trees is shown in Figure \ref{fig:DeadTreesExamplePhotos}. 
...
Diameter at breast height over bark (DBHOB) should be measured at the standard height of 1.3m (breast height). 

 In addition, the field plots used for the classifications are provided by (Interprine Group Ltd or Forest Corporation?) and contain around 1000 Eucalypt trees while 10\verb|%| of them are dead. 
 \begin{figure} [h!]
 	\centering
