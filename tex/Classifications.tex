...
\begin{itemize}
	\item Firstly, a pixelwise evaluation is done using the image produced with the prediction of whether a column from the voxelised FW LiDAR contains information from a dead tree or not. Example of output result is given in Figure \ref{fig:c9_sharpFilter}.
    \item Secondly, the predicted locations of the dead trees are evaluated in relation to their distance from the actual dead trees. Example of output is given in Figure \ref{fig:c11_results}. 	
\end{itemize}
